document.addEventListener('DOMContentLoaded', function () {
    ...
    const camposUltimaOsDiv = document.getElementById('campos-ultima-os');
    ...
    function loadData() {
        ...
        // Dispara eventos para garantir que a UI reflita os dados carregados
    ...
    function gerarTexto() {
        const agendamentoData = document.getElementById('agendamento_data').value;
        ...
        const quedas = document.getElementById('quedas').value;
        const tipoOs = document.getElementById('tipo_os').value;
        const dataOs = document.getElementById('data_os').value;
        const encerramentoOs = document.getElementById('encerramento_os').value;
    ...
    agendamentoPeriodoInput.addEventListener('change', function () {
        ...
        agendamentoHorarioInput.style.display = (periodo === 'apos') ? 'inline-block' : 'none';
        labelAgendamentoHorario.style.display = (periodo === 'apos') ? 'inline-block' : 'none';
        notificacaoHorarioP.style.display = (periodo === 'ultima' || periodo === 'apos') ? 'block' : 'none';
        if (periodo !== 'apos') {
    ...
    atendimentoInput.addEventListener('change', function () {
        camposUltimaOsDiv.style.display = (this.value === 'sim') ? 'block' : 'none';
    });
